...
def estimar_subvenciones(data: Comunidad):
    ...
    # ----------------------------
    # 2. Reducción energética estimada (criterio técnico real)
    # ----------------------------
    if superficie > 400:
    ...
    # ----------------------------
    # 3. CRITERIOS REALISTAS con los nombres que espera Xano
    # ----------------------------
    ...
    # ----------------------------
    # 5. 🔥 DEVOLVER EXACTAMENTE LA ESTRUCTURA QUE XANO ESPERA
    # ----------------------------
    return {
        "subvenciones": {
